...
When re-vendoring `skills/vastai/SKILL.md` from `vast-ai/vast-cli`, re-apply these unless upstream now includes them.
...
For the actual diff content, see `git log -- skills/vastai/SKILL.md`.
